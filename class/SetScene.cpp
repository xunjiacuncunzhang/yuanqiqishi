...
bool SetWorld::init()
{
	...
	auto* pButton1 = MenuItemImage::create("backbutton.png", "backbuttonselected.png", this, menu_selector(SetWorld::back));
...
void SetWorld::back(Object* pSender)
{
	//CocosDenshion::SimpleAudioEngine::sharedEngine()->stopBackgroundMusic("backgroundmusic.mp3");
	//Director::sharedDirector()->replaceScene(MyWorld::createScene());
