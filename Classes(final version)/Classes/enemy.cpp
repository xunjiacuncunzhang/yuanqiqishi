...
bool enemy::init()
{
	...
	auto* penemy1 = MenuItemImage::create("monster.png", "monster.png", this, menu_selector(enemy::enemy1));
	auto* enemy1 = Menu::create(penemy1, NULL, NULL);
	enemy1->setPosition(64, 448);
	//enemy1->setScale(2.0);
	this->addChild(enemy1, 1);

	auto* penemy2 = MenuItemImage::create("monster1.png", "monster1.png", this, menu_selector(enemy::enemy2));
	auto* enemy2 = Menu::create(penemy2, NULL, NULL);
	enemy2->setPosition(64, 352);
	//enemy2->setScale(2.0);
	this->addChild(enemy2, 1);

	auto* penemy3 = MenuItemImage::create("monstershooter.png", "monstershooter.png", this, menu_selector(enemy::enemy3));
	auto* enemy3 = Menu::create(penemy3, NULL, NULL);
	enemy3->setPosition(64, 256);
	//enemy3->setScale(2.0);
	this->addChild(enemy3, 1);

	auto* penemy4 = MenuItemImage::create("monsterwitcher.png", "monsterwitcher.png", this, menu_selector(enemy::enemy4));
...
void enemy::enemy1(Ref* pSender)
{
	...
	auto* enemyImage = Sprite::create("monster1.png");
...
void enemy::enemy2(Ref* pSender)
{
	...
	label->setPosition(visibleSize.width / 2 + 64, 480);
	addChild(label, 1, 1);
	auto* enemyImage = Sprite::create("monster.png");
	enemyImage->setPosition(visibleSize.width / 3, 288);
	enemyImage->setScale(2.0);
	this->addChild(enemyImage, 1, 2);
...
void enemy::enemy3(Ref* pSender)
{
	...
	label->setPosition(visibleSize.width / 2 + 64, 480);
	addChild(label, 1, 1);
	auto* enemyImage = Sprite::create("monstershooter.png");
	enemyImage->setPosition(visibleSize.width / 3, 288);
	enemyImage->setScale(2.0);
	this->addChild(enemyImage, 1, 2);
...
void enemy::enemy4(Ref* pSender)
{
	...
	label->setPosition(visibleSize.width / 2 + 64, 480);
	addChild(label, 1, 1);
	auto* enemyImage = Sprite::create("monsterwitcher.png");
	enemyImage->setPosition(visibleSize.width / 3, 288);
	enemyImage->setScale(2.0);
	this->addChild(enemyImage, 1, 2);
